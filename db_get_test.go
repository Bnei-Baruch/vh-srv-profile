...
VALUES ('441dc8be-7f58-40fb-951e-085797917110',
	...
	assert.Equal(t, userInput{
		...
		languages: languages{
			first:     pointerString("fr"),
			other1:    pointerString("en"),
			other2:    pointerString("zh"),
			other3:    pointerString("es"),
			other4:    pointerString("it"),
			listening: pointerString("en"),
			reading:   pointerString("he"),
