...
type grantInterface interface {
	GetGrantByIDAndUserID(ctx context.Context, id int, userID string) (Grant, error)
	...
	PatchGrantMembership(ctx context.Context, grant GrantMembership, grantId int) (int, error)
}
...
func (db *ProfileDB) GetGrantByIDAndUserID(ctx context.Context, id int, userID string) (Grant, error) {
	var grant Grant
	...
	if id != 0 {
		...
		return Grant{}, fmt.Errorf("invalid values")
	}
...
func (db *ProfileDB) CreateGrantMembership(ctx context.Context, req GrantAndGrantMembership) (int, error) {
...
func (db *ProfileDB) PatchGrantMembership(ctx context.Context, req GrantMembership, grantId int) (int, error) {
...
func (db *ProfileDB) getGrantMembershipByGrantID(ctx context.Context, grantId int) (GrantMembership, error) {

	var grantMemb GrantMembership
	...
	if err := db.QueryRow(ctx, `
		...
		if err == pgx.ErrNoRows {
			return GrantMembership{}, common.ErrNotFound
		}
		return GrantMembership{}, fmt.Errorf("error while getting grant membership: %w", err)
	}

	return grantMemb, nil
}

func (db *ProfileDB) PatchGrant(ctx context.Context, grant Grant, id int, requestID int) (int, error) {
...
func (db *ProfileDB) SoftDeleteGrantByID(ctx context.Context, id int) error {
...
func (db *ProfileDB) getNumberOfGrantMonthsUsedByGrantID(ctx context.Context, grantID int) (int, error) {
...
func prepareGrantMembershipUpdate(req GrantMembership) (string, []interface{}) {
