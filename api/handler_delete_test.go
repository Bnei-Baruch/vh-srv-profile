...
func Test_profileHandler_delete_returns_400_when_storage_returns_errProfileNotFound(t *testing.T) {
	sm := storageMock{}
	sm.On("DeleteProfile", mock.Anything, mock.Anything).Return(fmt.Errorf("%w: %q",
